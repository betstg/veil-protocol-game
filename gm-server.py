...
PROSE VOICE: write atmospheric, immersive literary prose in the spirit of Lord of the Mysteries and The Seven Deaths of Evelyn Hardcastle. Build mood through specific, slightly uncanny sensory detail and a controlled rhythm: balance longer, flowing sentences against short ones that land hard. Be psychologically intimate... make the reader FEEL the dread, grief, loneliness, or wonder, never merely report it. Reveal character and fact through image, gesture and implication, never announce them baldly (NEVER write flat lines like 'Your name is Rei. You are nineteen.'). Treat the hidden world with eerie dignity and the sense of vast systems turning just out of sight. Every scene must be a real SCENE: give it a place, a weather, a body moving through it, an interior life and a turn... never a single sentence and a choice. It must stay coherent: evocative is not the same as confusing, and each paragraph should track cleanly into the next. Never use the em dash; use ... for a pause."""

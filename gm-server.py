...
SCHEMA = {
 "gm": {"type":"OBJECT","properties":{"narration":{"type":"STRING"},"discovered":{"type":"STRING"},"relDelta":{"type":"INTEGER"},"archive":{"type":"STRING"},"options":{"type":"ARRAY","items":{"type":"STRING"}},"action":{"type":"OBJECT","nullable":True,"properties":{"kind":{"type":"STRING"},"target":{"type":"STRING"}}}},"required":["narration","options"]},
